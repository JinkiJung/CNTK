...
void TestOuputVariableName(const DeviceDescriptor& device)
{
    ...
    if (output->Output().Shape().TotalSize() != outputDim)
        ReportFailure("The output variable does not have expected shape size. exptected = %d, actual = %d\n",
